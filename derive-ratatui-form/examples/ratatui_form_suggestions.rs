//! Suggestions and assumptions example for the ratatui form backend.
//!
//! This example demonstrates:
//! - Setting default/suggested values that users can modify
//! - Editing existing data with with_suggestions
//!
//! Run with: cargo run -p derive-ratatui-form --example ratatui_form_suggestions

use derive_ratatui_form::RatatuiFormBackend;
use example_surveys::AppSettings;

fn main() -> anyhow::Result<()> {
    let backend = RatatuiFormBackend::new().with_title("Application Settings - New");
    ...
    let backend = RatatuiFormBackend::new().with_title("Application Settings - Edit");
